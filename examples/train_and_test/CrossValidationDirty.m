...
%24.02.2017
%%
function [ best_lambda1, best_lambda2, perform_mat] = CrossValidationDirty(X,...
                                                                           Y,...
                                                                           obj_func_str,...
                                                                           obj_func_opts,...
                                                                           lambda1_range,...
    ...
    perform_mat = mat2cell(perform_mat,size(perform_mat,1),ones(1,size(perform_mat,2)));%((40,200),40,ones(1,200))
